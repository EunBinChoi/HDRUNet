...
def parse(opt_path, is_train=True):
    ...
    if is_train:
        ...
        opt['path']['reference'] = osp.join(experiments_root, 'reference')
...
def check_resume(opt, resume_iter):
    ...
    if opt['path']['resume_state']:
        ...
        opt['path']['pretrain_model_G'] = osp.join(opt['path']['reference'],
                                                   '{}_G.pth'.format(resume_iter))
        logger.info('Set [pretrain_model_G] to ' + opt['path']['pretrain_model_G'])
        if 'gan' in opt['model']:
            opt['path']['pretrain_model_D'] = osp.join(opt['path']['reference'],
